...
module Database
  ...
  class Model
    ...
    #REFACTORED CODE
    # init = Cohort.new(id: 98, name: "Cohort 4", created_at: Time.now, updated_at: Time.now)
    # init
    # Cohort.update!
    # alltest_s = Student.all
    # alltest_c = Cohort.all
    # p alltest_c
    # #student tests
    # find_test = Cohort.find(1)
